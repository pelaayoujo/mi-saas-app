...
export default function UserDashboard() {
  ...
  // TEMPORAL: Mostrar dashboard sin autenticación para debug
  const isDebugMode = true

  if (isDebugMode) {
    // Modo debug - mostrar dashboard sin autenticación
        ...
        <header className="simple-header">
          <div className="header-content">
            ...
            <div className="user-info">
              <span>Modo Debug - Sin autenticación</span>
              <button 
  ...
  // Verificar autenticación (código original)
  if (status === 'loading') {
    return (
      <div className="simple-dashboard">
