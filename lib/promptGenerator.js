...
2. USA el formato markdown: # para título principal, ## para subtítulos
3. ESTRUCTURA: # Título, párrafo inicial, ## Subtítulos, ## Conclusión, hashtags al final
4. El contenido debe ser sobre: ${formData.topic}
5. Enfócate en: ${formData.professionalFocus}

Genera UN SOLO artículo usando el tono del ejemplo y la información específica proporcionada. NO incluyas etiquetas como "Título:" o "Gancho inicial:" - solo el contenido markdown limpio.`
}
