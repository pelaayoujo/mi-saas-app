...
export async function canGenerateContent(email, contentType = 'article') {
  try {
    ...
    // ACCESO DIRECTO para user@test.com (sin verificaciones complejas)
    if (email === 'user@test.com') {
      console.log('✅ Usuario admin directo autorizado')
      return { allowed: true, reason: null }
    }
    
    // Para otros usuarios: verificar que tengan plan válido
    try {
      ...
      console.error('❌ Error verificando usuario en DB:', dbError)
